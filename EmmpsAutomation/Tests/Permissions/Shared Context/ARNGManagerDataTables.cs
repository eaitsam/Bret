...
{
    public class ARNGManagerDataTables 
    {
        ...
        public DataTable LodPerms()
        {
            ...
            newRow = table.NewRow();
            newRow["Permission"] = "NGB Approval LOD & Appeal Review";
            newRow["Description"] = "Permits the user to own two 'NGB' Analyst/Admin LOD statuses.";
            newRow["AccessMod"] = "E";
            table.Rows.Add(newRow);

            newRow = table.NewRow();
            newRow["Permission"] = "NGB JAG LOD & Appeal Review";
            newRow["Description"] = "Permits the user to own two 'NGB' LOD statuses.The status permits the user to provide Legal Opinions";
            newRow["AccessMod"] = "E";
            table.Rows.Add(newRow);
            ...
            newRow = table.NewRow();
            newRow["Permission"] = "NGB JAG LOD & Appeal Review";
            newRow["Description"] = "NGB Surgeon LOD & Appeal Review";
            newRow["AccessMod"] = "E";
            table.Rows.Add(newRow);
        ...
        public DataTable ADOPPerms()
        {
            ...
            newRow = table.NewRow();
            newRow["Permission"] = "NGB ADOP Admin Review: Documents Tab";
            ...
            newRow = table.NewRow();
            newRow["Permission"] = "RCMC Surgeon Complete";
            newRow["Description"] = "Permits full-access to thet RCMC Surgeon Complete status";
            newRow["AccessMod"] = "E";
            table.Rows.Add(newRow);
