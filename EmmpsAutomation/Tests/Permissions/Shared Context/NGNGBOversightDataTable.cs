...
namespace EmmpsAutomation.Tests.Permissions.Shared_Context
{
    ...
    class NGNGBOversightDataTable
    {
        ...
        public DataTable PDHRAPerms()
        {
            ...
            newRow = table.NewRow();
            newRow["Permission"] = "NGB PDHRA Manager Review";
        ...
        public DataTable ADOPPerms()
        {
            ...
            newRow["Description"] = "Permits full-accesss to the documents tab of ADOPs in NGB ADOP Admin Review status";
            newRow["AccessMod"] = "E";
            table.Rows.Add(newRow);
