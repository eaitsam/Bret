...
{
    public class MSCMedicalReviewDataTables
    {
        //	| Tabs                                                         |
        ...
        public DataTable LODPerms()
        {
            ...
            DataRow newRow = table.NewRow();
            newRow["Permission"] = "MSC LOD Medical Review";
            newRow["Description"] = "Permits the user to own a MSC LOD status that fall in one or more workflows.The status permits the user to provide Medical Opinions";
            newRow["AccessMod"] = "D";
            table.Rows.Add(newRow);
