...
{
    public class NGUnitCommanderDataTables
    {
        ...
        public DataTable LodPerms()
        {
            ...
            newRow = table.NewRow();
            newRow["Permission"] = "Unit Commander LOD Review (NG)";
        ...
        public DataTable PDHRAPerms()
        {
            ...
            newRow = table.NewRow();
            newRow["Permission"] = "Unit Commander PDHRA Review (NG)";
            newRow["Description"] = "Permits the user to own a specific status in the PDHRA workflow.The user will be able to approve the PDHRA Referrals.";
            newRow["AccessMod"] = "E";
            table.Rows.Add(newRow);
