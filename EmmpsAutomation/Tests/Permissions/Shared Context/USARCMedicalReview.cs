...
{
    public class USARCMedicalReview
    {
        //	| Tabs                            |
        ...
        public DataTable LodPerms()
        {
            ...
            newRow["Permission"] = "USARC LOD Medical & Appeal Medical Review";
            newRow["Description"] = "Permits the user to own two specific USARC LOD statuses that fall in one or more workflows.The status permits the user to provide Medical Opinions";
            newRow["AccessMod"] = "D";
            table.Rows.Add(newRow);
        ...
        public DataTable INCAPPerms()
        {
            ...
            newRow = table.NewRow();
            newRow["Permission"] = "USARC INCAP Medical & Appeal Review";
            newRow["Description"] = "Permits the user to review INCAPs and provide medical opinion.";
            newRow["AccessMod"] = "D";
            table.Rows.Add(newRow);
        ...
        public DataTable ADOPPerms()
        {
            ...
            newRow = table.NewRow();
            newRow["Permission"] = "USARC Surgeon Approval & ARNG Packet Review";
            newRow["Description"] = "Permits full-access to the Army Reserve USARC Surgeon Approval statuses";
            newRow["AccessMod"] = "E";
            table.Rows.Add(newRow);
