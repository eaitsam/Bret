...
{
    public class MSCApprovalDataTables
    {
        //	| Tabs                                                         |
        ...
        public DataTable LODPerms()
        {
            ...
            DataRow newRow = table.NewRow();
            newRow["Permission"] = "MSC Approval & Appointing Authority Review (AR)";
            newRow["Description"] = "Permits the user to own a specific status in Army Reserve LOD workflows.These statuses permit the user to select an I/O and edit the DD Form 261";
            newRow["AccessMod"] = "D";
            table.Rows.Add(newRow);
