...
{
    public class NGAppointingAuthorityDataTables
    {
        ...
        public DataTable LodPerms()
        {
            ...
            DataRow newRow = table.NewRow();
            newRow["Permission"] = "Appointing Authority (NG) & Investigation Review";
            newRow["Description"] = "Permits the user to own a specific status in the National Guard LOD workflows.These statuses permit the user to select an I/O and edit the DD Form 261";
            newRow["AccessMod"] = "D";
            table.Rows.Add(newRow);
