...
{
    //@Case46201
    //Scenario: EMMPS My Account Permissions - NG State Surgeon
    //	Given I am Logged in as "State Surgeon" using EDIPIN 8880070112
    //	When I select the My Account Page Link in the MEDCHART tile
    //	Then my Module Access Details should be correct for my "State Surgeon" role
    //	| Tabs                                                         |
    //	| eMMPS Administration, LOD, INCAP, PDHRA, MMSO, ADOP, Reports |
    class NGStateSurgeonDataTables
    {
        //	And the Permissions for "LOD" are correct for State Surgeon in NG
        ...
        //	| State Surgeon LOD & Appeal Review           | Permits the user to own two National Guard 'State' LOD statuses.The status permits the user to provide Medical Opinions       | D               |
        ...
        //	And the Permissions for "MMSO" are correct for State Surgeon in NG
        //	| Permission                          | Description                                                                                                                     | Access Modifier |
        ...
        //	And the Permissions for "INCAP" are correct for State Surgeon in NG
        //	| Permission                          | Description                                                                                                                      | Access Modifier |
        //	| Search/View an INCAP                | Permits the user to search and view INCAP.                                                                                       | D               |
        //	| State Surgeon INCAP & Appeal Review | Permits the user to review INCAPs and provide a medical opinion.                                                                 | D               |
        ...
        //	And the Permissions for "PDHRA" are correct for State Surgeon in NG
        //	| Permission                     | Description                                                                                                                      | Access Modifier |
        ...
        //	And the Permissions for "ADOP" are correct for State Surgeon in NG
        //	| Permission                    | Description                                                                                                                                                       | Access Modifier |
        //	| Search/View ADOP Cases        | Permits the user to search for and view ADOP cases                                                                                                                | D               |
        //	| State Surgeon ADOP Statuses   | Permits the user to own multiple ADOP statuses that fall in one or more workflows. The user will be have read/write access to the Documents and Next Action page. | D               |
        ...
        public DataTable ADOPPerms()
        {
            ...
            newRow["Description"] = "Permits the user to own multiple ADOP statuses that fall in one or more workflows. The user will be have read/write access to the Documents and Next Action page.";
            newRow["AccessMod"] = "D";
            table.Rows.Add(newRow);
        ...
        //	And the Permissions for "Reports" are correct for State Surgeon in NG
        //	| Permission | Description | Access Modifier |
        ...
        //	And the Permissions for "eMMPS Administration" are correct for State Surgeon in NG
        //	| Permission       | Description                                                                                              | Access Modifier |
