...
{
    public class USARCG1AdminDataTables
    {
        ...
        public DataTable LodPerms()
        {
            ...
            newRow = table.NewRow();
            newRow["Permission"] = "LOD Appeal Draft (AR)";
            newRow["Description"] = "Permits the user to own an initial Army Reserves LOD Appeal status";
            newRow["AccessMod"] = "E";
            table.Rows.Add(newRow);
            ...
            //	| Override Unrestricted LOD                | Permits the user to change the status of Unrestricted LOD within the scope of the user.                                        | D               |
            //	| Restore Deleted Unrestricted Assault LOD | Permits the user to restore deleted unrestricted LODs within the scope of the user.                                            | D               |
