...
{
    class CrossComLeadHRCReviewerDataTable
    {
        ...
        public DataTable LodPerms()
            {
                ...
                newRow = table.NewRow();
                newRow["Permission"] = "HRC Approval LOD Appeal Review (AR)";
                ...
                newRow = table.NewRow();
                newRow["Permission"] = "HRC Approval LOD Appeal Review (NG)";
                newRow["Description"] = "Permits the user to own a specific HRC status in the National Guard LOD Appeal workflow. The status permits the user to approve LOD Appeals.";
                newRow["AccessMod"] = "E";
                table.Rows.Add(newRow);

                newRow = table.NewRow();
                newRow["Permission"] = "HRC Approval LOD Review (AR)";
                newRow["Description"] = "Permits the user to own a specific HRC status in the Army Reserve LOD workflow.The status permits the user to approve Death LODs";
                newRow["AccessMod"] = "E";
                table.Rows.Add(newRow);

                newRow = table.NewRow();
                newRow["Permission"] = "HRC Approval LOD Review (NG)";
                newRow["Description"] = "Permits the user to own a specific HRC status in the National Guard LOD workflow.The status permits the user to approve Death LODs";
                newRow["AccessMod"] = "E";
                table.Rows.Add(newRow);
