...
{
    public class USARDivRLegalReview
    {
        //	Then my Module Access Details should be correct for my "DIVR Legal Review" role
        //	| Tabs                            |
        ...
        public DataTable LODPerms()
        {
            ...
            DataRow newRow = table.NewRow();
            newRow["Permission"] = "DIV(R) LOD Legal Review";
            newRow["Description"] = "Permits the user to own a DIV(R) LOD status that fall in one or more workflows.The status permits the user to provide Legal Opinions";
            newRow["AccessMod"] = "D";
            table.Rows.Add(newRow);
        ...
        public DataTable INCAPPerms()
        {
            ...
            DataRow newRow = table.NewRow();
            newRow["Permission"] = "DIV(R) INCAP Legal & Appeal Review";
