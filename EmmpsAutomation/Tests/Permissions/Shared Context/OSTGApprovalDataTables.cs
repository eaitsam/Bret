...
{
    public class OSTGApprovalDataTables
    {
        ...
        public DataTable ADOPPerms()
        {
            ...
            newRow = table.NewRow();
            newRow["Permission"] = "OTSG Statuses (AR)";
            newRow["Description"] = "Permits full-access to the Army Reserve OTSG statuses";
            newRow["AccessMod"] = "D";
            table.Rows.Add(newRow);

            newRow = table.NewRow();
            newRow["Permission"] = "OTSG Statuses (NG)";
            newRow["Description"] = " Permits full-access to the National Guard OTSG statuses";
            newRow["AccessMod"] = "D";
            table.Rows.Add(newRow);
