...
{
    public class ARUnrestrictedAssaultInformal
    {
        //Test Script 54766
        readonly string fileName = "ARUnrestrictedAssaultInformal.xlsx";
        ...
        public ARUnrestrictedAssaultInformal()
        {
        ...
        [Fact]
        public void ARUnrestrictedAssaultInformalStartLOD()
        {
        ...
        [Fact]
        public void ARUnrestrictedAssaultInformalUsarcSarcManager()
        {
            //test = extent.CreateTest("NGPreApprovedInformalStartLOD", "StartLOD");
        ...
        public void StartLOD(string edipin, string id)
        {
            try
            {
                ...
                UIActions.TypeInTextBox(startNewLOD.ExceptionToPolicyCommentBox, "New AR Unrestricted Assault Informal Workflow");
                UIActions.JSClickElement(startNewLOD.NextButton);
                //check to make sure the rank field is selected if not sets it
                UIActions.SelectElementByText(startNewLOD.WorkflowDropDownBox, "AR Unrestricted Assault (Informal)");
                UIActions.ClickElement(startNewLOD.IDESCase);
                ...
                UIActions.SelectElementByText(nextActionTab.NextActionControlDropDownList, "Forward To USARC Assault Approval Review (AR)");
        ...
        public void UsarcSarcManager(string edipin)
        {
            try
            {
                ...
                UIActions.SelectElementByText(searchPage.LODComboBoxWorkflow, "AR Unrestricted Assault (Informal)");
