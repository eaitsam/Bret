...
{
    public class ARDeathInformal
    {
        //Test Script 54747

        readonly string fileName = "ARDeathInformal.xlsx";
        ...
        [Fact]
        public void ARDeathInformalStartLOD()
        {
        ...
        [Fact]
        public void ARDeathInformalUnitCommander()
        {
            ExcelUtil.PopulateInCollection(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, (@"Dataseed\Parameter Files\LOD\" + fileName)));
            int b = ExcelUtil.GetTotalRowCount();
        ...
        [Fact]
        public void ARDeathInformalMSCAdmin()
        {
            ExcelUtil.PopulateInCollection(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, (@"Dataseed\Parameter Files\LOD\" + fileName)));
            int b = ExcelUtil.GetTotalRowCount();
        ...
        [Fact]
        public void ARDeathInformalDivRAdmin()
        {
            ExcelUtil.PopulateInCollection(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, (@"Dataseed\Parameter Files\LOD\" + fileName)));
            int b = ExcelUtil.GetTotalRowCount();
        ...
        [Fact]
        public void ARDeathInformalUSARCAdmin()
        {
            ExcelUtil.PopulateInCollection(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, (@"Dataseed\Parameter Files\LOD\" + fileName)));
            int b = ExcelUtil.GetTotalRowCount();
        ...
        [Fact]
        public void ARDeathInformalUSARCApproval()
        {
            ExcelUtil.PopulateInCollection(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, (@"Dataseed\Parameter Files\LOD\" + fileName)));
            int b = ExcelUtil.GetTotalRowCount();
        ...
        [Fact]
        public void ARDeathInformalHRCReviewer()
        {
            ExcelUtil.PopulateInCollection(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, (@"Dataseed\Parameter Files\LOD\" + fileName)));
            int b = ExcelUtil.GetTotalRowCount();
        ...
        [Fact]
        public void ARDeathInformalLeadHRCReviewer()
        {
            ExcelUtil.PopulateInCollection(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, (@"Dataseed\Parameter Files\LOD\" + fileName)));
            int b = ExcelUtil.GetTotalRowCount();
        ...
        public void StartLOD(string edipin, string id)
        {
            try
            {
                ...
                WaitMethods.Wait(startNewLOD.SsnBox, 60);
                ...
                UIActions.TypeInTextBox(startNewLOD.ExceptionToPolicyCommentBox, "New AR Death Informal Workflow");
                UIActions.JSClickElement(startNewLOD.NextButton);
                UIActions.SelectElementByText(startNewLOD.WorkflowDropDownBox, "AR Death (Informal)");
        ...
        public void UnitCommander(string edipin)
        {
            try
            {
                ...
                UIActions.SelectElementByText(searchPage.LODComboBoxWorkflow, "AR Death (Informal)");
