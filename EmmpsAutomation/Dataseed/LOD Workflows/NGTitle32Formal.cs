...
{
    public class NGTitle32Formal
    {
        //Test Script 58411

        readonly string fileName = "NGTitle32Formal.xlsx";
        ...
        [Fact]
        public void NGTitle32FormalStartLOD()
        {
        ...
        [Fact]
        public void NGTitle32FormalUnitCommander()
        {
            //test = extent.CreateTest("NGPreApprovedFormalStartLOD", "StartLOD");
        ...
        [Fact]
        public void NGTitle32FormalIntermediateCommand()
        {
            //test = extent.CreateTest("NGPreApprovedFormalStartLOD", "StartLOD");
        ...
        [Fact]
        public void NGTitle32FormalAppointingAuthority()
        {
            //test = extent.CreateTest("NGPreApprovedFormalStartLOD", "StartLOD");
        ...
        [Fact]
        public void NGTitle32FormalInvestigatingOfficer()
        {
            //test = extent.CreateTest("NGPreApprovedFormalStartLOD", "StartLOD");
        ...
        [Fact]
        public void NGTitle32FormalAppointingAuthority2()
        {
            //test = extent.CreateTest("NGPreApprovedFormalStartLOD", "StartLOD");
        ...
        [Fact]
        public void NGTitle32FormalStateAdmin()
        {
            //test = extent.CreateTest("NGPreApprovedFormalStartLOD", "StartLOD");
        ...
        [Fact]
        public void NGTitle32FormalStateApproval()
        {
            //test = extent.CreateTest("NGPreApprovedFormalStartLOD", "StartLOD");
        ...
        [Fact]
        public void NGTitle32FormalNGBReviewer()
        {
            //test = extent.CreateTest("NGPreApprovedFormalStartLOD", "StartLOD");
        ...
        [Fact]
        public void NGTitle32FormalNGBApproval()
        {
            //test = extent.CreateTest("NGPreApprovedFormalStartLOD", "StartLOD");
        ...
        public void StartLOD(string edipin, string id)
        {
            try
            {
                ...
                UIActions.TypeInTextBox(startNewLOD.ExceptionToPolicyCommentBox, "New NG Title 32 Formal Workflow");
                UIActions.JSClickElement(startNewLOD.NextButton);
                startNewLOD.VerifyRankSelected("Specialist (SPC)");
                UIActions.SelectElementByText(startNewLOD.WorkflowDropDownBox, "NG Title 32 (Formal)");
                //UIActions.JSEnterText(MemberUIC, "W77749");
                ...
                medicalTab.NewLODMedicalTabBasicRequiredFieldsEntry("Military", "Admitted", "Disease", "Yes", "A150", "Automation Test", "-5", "Dr. Test", "No", "No", "Yes", "-5", "-5");
        ...
        public void UnitCommander(string edipin, string intcommandreview)
        {
            try
            {
                ...
                UIActions.SelectElementByText(searchPage.LODComboBoxWorkflow, "NG Title 32 (Formal)");
        ...
        public void InvestigatingOfficer(string edipin)
        {
            try
            {
                ...
                investigationTab.UpdateRequiredFieldsInvestigationTab("-30", "Disease", "-60", "Sickness", "Fell down", "Sickness", "No", "No", "Yes", "Automation Test", "In Line Of Duty", "National Guard", "With Authority");
                //pass "30 Days or More" or "30 Days or Less" for second option the the method
