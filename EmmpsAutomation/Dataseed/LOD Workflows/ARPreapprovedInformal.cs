...
{
    public class ARPreapprovedInformal
    {
         //Test Script 54730

        readonly string fileName = "ARPreapprovedInformal.xlsx";
        ...
        [Fact]
        public void ARPreapprovedInformalStartLOD()
        {
        ...
        [Fact]
        public void ARPreapprovedInformalDIVRAdmin()
        {
            //test = extent.CreateTest("NGPreApprovedFormalStartLOD", "StartLOD");
        ...
        [Fact]
        public void ARPreapprovedInformalUsarcAdmin()
        {
            //test = extent.CreateTest("NGPreApprovedFormalStartLOD", "StartLOD");
        ...
        [Fact]
        public void ARPreapprovedInformalUsarcApproval()
        {
            //test = extent.CreateTest("NGPreApprovedFormalStartLOD", "StartLOD");
        ...
        public void StartLOD(string edipin, string id)
        {
            try
            {
                ...
                UIActions.TypeInTextBox(startNewLOD.ExceptionToPolicyCommentBox, "New AR PreApproved Informal Workflow");
                UIActions.JSClickElement(startNewLOD.NextButton);

                //check to make sure the rank field is selected if not sets it
                UIActions.SelectElementByText(startNewLOD.WorkflowDropDownBox, "AR Pre-Approved (Informal)");
                WaitMethods.WaitForAnimationtoComplete(misc.WaitingAnimationDiv, 60);
                UIActions.ClickElement(startNewLOD.ABCMRCase);
        ...
        public void DIVRAdmin(string edipin)
        {
            try
            {
                ...
                UIActions.SelectElementByText(searchPage.LODComboBoxWorkflow, "AR Pre-Approved (Informal)");
