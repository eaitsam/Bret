...
//{
//    public class ARRestrictedPreAuth
//    {
//        //Test Script 55391
...
//        string fileName = "ARMMSORestrictedPreAuth.xlsx";
...
//        [Fact]
//        public void ARRestrictedPreAuthStartMMSO()
//        {
...
//        [Fact]
//        public void ARRestrictedPreAuthMMSOReviewer()
//        {
//            //test = extent.CreateTest("NGPreApprovedFormalStartLOD", "StartLOD");
...
//                UIActions.SelectElementByText(startNewMMSO.MMSOWorkflowDropDownBox, "AR Restricted Pre-Auth [Form 01]");
...
//                //Section III
//                //(string miles, string milesFromPlaceType, string unitPoc, string PocPhone, string PocEmail,  string formType (form01=PreAuth,  Type of Orders))
...
//                //if (startNewMMSO.MMSONextActionSignButton.Exists)
//                //{
//                    //WaitMethods.Wait(startNewMMSO.MMSONextActionSignButton);
...
//                UIActions.SelectElementByText(startNewMMSO.MMSOComboBoxWorkflow, "AR Restricted Pre-Auth [Form 01]");
