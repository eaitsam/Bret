...
namespace EFMPAutomation
{
    public class SplashPageTest
    {
        ...
        private readonly YahooPage _yahoopage;
        ...
        public SplashPageTest()
        {
            ...
            _yahoopage = new YahooPage();
            _webSiteUrl = _config.GetConfigValue("YahooURL");
        ...
        public void EFMPLogon()
        {
            ...
            try
            {
                ...
                //_homepage.ClickUserInfo();

                _yahoopage.WriteinYahooSeatchBar();
